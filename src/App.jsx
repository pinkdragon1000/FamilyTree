...
function App() {
  ...
  const [cardNavStack, setCardNavStack] = useState([
  ...
  return (
    <>
      ...
      {viewMode === "card" && (
        <CardView
          data={data}
          navStack={cardNavStack}
          setNavStack={setCardNavStack}
          onJumpToTree={jumpToTreePerson}
          searchTargetId={cardSearchTarget}
          onSearchTargetHandled={() => setCardSearchTarget(null)}
        />
      )}
      {viewMode === "tree" && (
        <TextSizeControls
